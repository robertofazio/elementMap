...
{	
    ...
    //video
    elemV1.setup("","", outputResolutionX,outputResolutionY, ELM_INPUT_STEREO_TWO_CHANNEL, LEFT_MARGIN_X , UPPER_MARGIN_Y+STRIP_HEIGHT,"Movie", true);
...
{	
        ...
        
    {
        ...
        fontLarge.drawString("element.Map v0.3.1 ", 70 , 44);
